...
public class PizzahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pizzah);
        timer1=System.currentTimeMillis();

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        screenViewEvent("pizza screen");
    }
    ...
    void screenViewEvent(String screenName){
        ...
        bundle.putString(FirebaseAnalytics.Param.SCREEN_CLASS, "PizzahActivity");
