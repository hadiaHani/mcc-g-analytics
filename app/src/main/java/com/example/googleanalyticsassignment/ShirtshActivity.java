...
public class ShirtshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shirtsh);
        timer1=System.currentTimeMillis();

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        screenViewEvent("shirts screen");
    }
    ...
    void screenViewEvent(String screenName){
        ...
        bundle.putString(FirebaseAnalytics.Param.SCREEN_CLASS, "ShirtshActivity");
