...
public class ShawermaaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shawermaa);
        timer1=System.currentTimeMillis();

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        screenViewEvent("shawermaa screen");
    }
    ...
    void screenViewEvent(String screenName){
        ...
        bundle.putString(FirebaseAnalytics.Param.SCREEN_CLASS, "ShawermaaActivity");
