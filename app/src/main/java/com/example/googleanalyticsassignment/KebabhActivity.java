...
public class KebabhActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kebabh);
        timer1=System.currentTimeMillis();

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        screenViewEvent("Kebab screen");
    }
    ...
    void screenViewEvent(String screenName){
        ...
        bundle.putString(FirebaseAnalytics.Param.SCREEN_CLASS, "KebabhActivity");
